...
[`@aws-sdk/client-chime-sdk-media-pipelines`](https://www.npmjs.com/package/@aws-sdk/client-chime-sdk-media-pipelines/v/3.1066.0).
...
- @aws-sdk/client-chime-sdk-media-pipelines v3.1066.0 - [https://cloud-sdk-builds.github.io/?sdk=client-chime-sdk-media-pipelines&version=3.1066.0](https://cloud-sdk-builds.github.io/?sdk=client-chime-sdk-media-pipelines&version=3.1066.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-media-pipelines@3.1066.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OWvbasY5+PU9TFC+dWTUrPootrcPPA+lCXKUzpPkCBpt/7xfRppTKz+fDNoP0mt4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-chime-sdk-media-pipelines": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-media-pipelines@3.1066.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime-sdk-media-pipelines@3.1066.0/index.min.mjs": "sha384-OWvbasY5+PU9TFC+dWTUrPootrcPPA+lCXKUzpPkCBpt/7xfRppTKz+fDNoP0mt4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-chime-sdk-media-pipelines/blob/refs/tags/3.1066.0/LICENSE
```
